 ...
 * @author caiov
 */
public class TelaMatriculas extends javax.swing.JFrame {

    /**
     * Creates new form TelaMatriculas
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaMatriculas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
